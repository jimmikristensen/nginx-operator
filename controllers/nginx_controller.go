...
const nginxFinalizer = "webserver.nginx.example.com/finalizer"
...
//+kubebuilder:rbac:groups=webserver.nginx.example.com,resources=nginxes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webserver.nginx.example.com,resources=nginxes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webserver.nginx.example.com,resources=nginxes/finalizers,verbs=update
...
func (r *NginxReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("Reconciliation loop processing")
	...
	log.Info("Reconciliation loop done")
	return ctrl.Result{}, nil
}

// finalizeNginx will perform the required operations before delete the CR.
func (r *NginxReconciler) doFinalizerOperationsForNginx(cr *webserverv1alpha1.Nginx) {
...
func (r *NginxReconciler) deploymentForNginx(
	nginx *webserverv1alpha1.Nginx) (*appsv1.Deployment, error) {
